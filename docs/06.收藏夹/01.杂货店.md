...
tags: 
  - 收藏夹
date: 2021-09-21 15:17:08
---
[尤雨溪创立vue的心路历程](https://www.youtube.com/watch?v=OrxmtDw4pVI) 原声版 👨🏻‍💻

[中文版](https://www.bilibili.com/video/BV1iE411H71U)  翻译比youtube的机翻较准确 🤩
...
* [编程语言排行榜](https://www.tiobe.com/tiobe-index/) :1st_place_medal:
* [IP地址查询](https://githubusercontent.com.ipaddress.com/) 找到网站的真实IP地址，以便后续拷贝到host文件中
* [notion](https://www.notion.so/) 类似国内语雀等笔记网站，也可以基于此实现个人博客的搭建 【持续更新!】
* [图床](https://imgtu.com/) 使用CDN加速，提供上传和外链服务，但依然推荐jsdelivr，具体使用方法请百度

* [Netnr](https://netnr.top/) 提供脚本及其他服务

* [wallpaper壁纸](https://ss.netnr.com/wallpaper) netur提供的wallpaper壁纸，无需代理


## 博客工具
* [Markdown](https://www.webfx.com/tools/emoji-cheat-sheet/) 给makedown添加好看的emoji(其实也不是很好看，不如微软自带拼音里面的表情库)
* [Travis_Ci自动化推送](https://app.travis-ci.com/) 给博客添加自动化部署方式，真正实现一键部署
* [谷歌统计分析](https://analytics.google.com/) 网站统计流量分析的鼻祖，但是需要翻墙，且要时不时手动刷新
* [百度统计分析](https://tongji.baidu.com/) 类似谷歌的流量分析，在国内，避免网络困扰
* [阿里巴巴矢量图](https://www.iconfont.cn/)提供好看的图表和插画
...
## 社区
* [Github](https://github.com/) :100::程序员同性交友社区:1st_place_medal:
